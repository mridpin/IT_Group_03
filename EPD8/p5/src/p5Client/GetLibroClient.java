 ...
 * USAGE:
 * <pre>
 *        GetLibroClient client = new GetLibroClient();
...
// Returns an ArrayList of libros from the web service
    ...
    public GetLibroClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("entidades.libro");
    }

    public String getHtml(String id) throws ClientErrorException {
